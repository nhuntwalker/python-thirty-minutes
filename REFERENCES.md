...
2. [The official Style Guide for Python Code](https://www.python.org/dev/peps/pep-0008/)
3. [Python "random" library](https://docs.python.org/3/library/random.html)
4. [ASCII Art](https://en.wikipedia.org/wiki/ASCII_art)
5. [How to use Date and Time in Python](http://www.pythonforbeginners.com/basics/python-datetime-time-examples)

## Chapter 3

1. [Python: A Strong, Dynamically Typed Language](http://www.oznetnerd.com/python-strong-dynamically-typed-language/)
2. [The Difference between Compiled and Interpreted Languages](https://www.lifewire.com/compiled-language-2184210)
3. [Support for type hints](https://docs.python.org/3/library/typing.html)
